...
{
    var s = "";
    s += '<object id="' + this.prefix + this.id + '" style="width:' + this.width + ';height:' + this.height + ';" codebase="/module/AIP/HWPostil.cab" classid="clsid:FF3FE7A0-0578-4FEE-A54E-FB21B277D567">';
